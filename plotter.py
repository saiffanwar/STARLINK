...
odd_offsets = phase_offsets[1::2]
odd_distances = [i/1000 for i in min_distances[1::2]]
# print([str(i) for i in odd_offsets])
USABLE_WIDTH_mm = 180
USABLE_HEIGHT_mm = 80
